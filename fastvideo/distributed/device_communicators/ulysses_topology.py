...
# (PR #3820, "Feat/ulysses p2p a2a"), file: comm/ulysses_topology.py
#
# Verbatim: this module imports only stdlib, torch and torch.distributed.
#
# Do not edit locally beyond the noted substitutions -- re-sync from upstream.
